...
This is the context file for *this* repository -- the one about context engineering. For usage notes and an overview of what's here, read the [README](README.md).
...
- `claude-md-single-file/` -- Four single-file CLAUDE.md examples at different complexity levels
...
2. **Fenced template** -- the actual CLAUDE.md content the reader would copy, wrapped in backtick fences
