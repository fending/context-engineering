...
- **[minimal.md](minimal.md)** -- The smallest useful context file. Start here.
- **[saas-app.md](saas-app.md)** -- Full context for a multi-layer product with auth, data model, and API conventions.
- **[api-service.md](api-service.md)** -- Backend API with endpoint patterns, data layer rules, and integration points.
- **[cli-tool.md](cli-tool.md)** -- Command-line tool with exit codes, output formatting, and cross-platform concerns.
